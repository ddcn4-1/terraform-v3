...
resource "aws_db_instance" "postgres" {
  ...
  # Restore from Seoul snapshot
  snapshot_identifier = "hs-eks-tokyo-postgres-restored"
  ...
  # Database configuration (inherited from snapshot)
  # db_name  = var.rds_database_name  # Commented: inherited from snapshot
  # username = var.rds_username        # Commented: inherited from snapshot
  password = var.rds_password          # Can set new password
  port     = var.rds_port
